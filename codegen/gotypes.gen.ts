...
export class Message {
  ...
  constructor(source: any = {}) {
    ...
    this.thinkingTimeStart =
      source["thinkingTimeStart"] && new Date(source["thinkingTimeStart"]);
    this.thinkingTimeEnd =
      source["thinkingTimeEnd"] && new Date(source["thinkingTimeEnd"]);
  }
...
export class InferenceComputeResponse {
  ...
  constructor(source: any = {}) {
    if ("string" === typeof source) source = JSON.parse(source);
    this.inferenceComputes = this.convertValues(
      source["inferenceComputes"],
      InferenceCompute,
    );
