// Bounds of a measured element, already restated in the coordinate space of the overlay that consumes them — a raw
// measureInWindow reading is not that space, see anchorRelativeTo and Platform notes (Android).
